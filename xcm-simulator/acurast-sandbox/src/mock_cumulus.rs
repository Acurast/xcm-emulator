...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		ProxyPallet: proxy_pallet::{Pallet, Call, Storage, Event<T>} = 41,
	}
);

parameter_types! {
	pub const AcurastParachainId: u32 = 1;
	pub const AcurastPalletId: u32 = 41;
}

impl proxy_pallet::Config for Runtime {
	type Event = Event;
